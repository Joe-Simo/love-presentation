...
export const VIBE_OPTIONS: Array<{
  ...
  {
    value: "boardroom",
    label: "Boardroom proof",
    description: "Very official. Deeply unserious.",
  },
  {
    value: "chaos",
    label: "Chaotic evidence",
  ...
  return [
    {
      ...
      title: `Why ${couple} is suspiciously perfect`,
      body: pick(pack.opener),
      verdict: "Prepared with confidence, zero chill, and tasteful typography.",
    },
    {
      id: "compatibility",
      kicker: "Compatibility Forecast",
      title: "The vibe graph is refusing to be subtle",
